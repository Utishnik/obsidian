...
я так и не понял откуда его значению берутся надо разобраться + конкретно что деалет dotick и в функции по записи Write и они видно чанки и есть типо  delta snap но не понятно полная картина.